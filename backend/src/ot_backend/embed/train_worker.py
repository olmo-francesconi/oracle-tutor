...
from .registration import register_model_bundle_bytes, semantic_model_artifact_keys
...
logger = logging.getLogger("ot_backend.embed.train_worker")


def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m ot_backend.embed.train_worker")
